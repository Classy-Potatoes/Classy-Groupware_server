...
import static com.potatoes.cg.common.exception.type.ExceptionCode.NOT_FOUND_MEMBER_NON_STATUS;
...
public class LoginFailureHandler extends SimpleUrlAuthenticationFailureHandler {
    ...
    public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response, AuthenticationException exception) throws IOException, ServletException {
        ...
        if( exception instanceof DisabledException ) {
            exceptionResponse = new ExceptionResponse( NOT_FOUND_MEMBER_NON_STATUS );
        } else {
            exceptionResponse = new ExceptionResponse( FAIL_LOGIN );
        }
